...
utilisateur_patterns = [
    path('', views.list_utilisateurs, name='list_utilisateurs'),
    path('add/', views.add_utilisateur, name='add_utilisateur'),
    path('update/<int:id>/', views.update_utilisateur, name='update_utilisateur'),
    path('delete/<int:id>/', views.delete_utilisateur, name='delete_utilisateur'),
    path('detail/<int:id>/', views.detail_utilisateur, name='detail_utilisateur'),
    path('role/<str:role>/', views.list_utilisateurs_by_role, name='list_utilisateurs_by_role'),
    path('recherche/', views.search_utilisateurs, name='search_utilisateurs'),
]
